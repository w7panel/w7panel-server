...
import (
	v1alpha1 "github.com/w7panel/w7panel/k8s/pkg/client/cvm/clientset/versioned/typed/cvm/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeCvmV1alpha1 struct {
	*testing.Fake
}

func (c *FakeCvmV1alpha1) Cvms(namespace string) v1alpha1.CvmInterface {
