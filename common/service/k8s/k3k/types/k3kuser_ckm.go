...
*	同步ckm 中的权限数据到k3k
	...
	w7.cc/menu: >-
	    ["cluster","cluster-panel","app","app-apps","app-apps-add","app-apps-edit","app-apps-delete","app-cronjob","app-cronjob-add","app-cronjob-edit","app-cronjob-delete","app-rvproxy","app-rvproxy-add","app-rvproxy-edit","app-rvproxy-delete","storage","storage-node","storage-node-add","storage-node-edit","storage-node-delete","storage-zone","system","system-cloud","system-cost","system-order-center","system-cost-center"]
...
func (u *k3kUser) ReplaceCkm(ckm *cvmv1alpha1.Ckm) {
	...
	u.Annotations[W7_SERVER0_POD_NAME] = ckm.Status.Server0PodName // statuful
