...
// ErrNotFound returns the sentinel error used to indicate a blob was not found.
// BlobHandler implementations should return this exact error (or wrap it) so
// the registry can respond with the correct BLOB_UNKNOWN error code.
