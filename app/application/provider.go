...
func (p Provider) RegisterHttpRoutes(server *httpserver.Server) {
	...
	server.RegisterRouters(func(engine *gin.Engine) {
		...
		localApiGroup := engine.Group("/panel-api/v1") //.Use(middleware.Cors{}.Process)
		{
			...
			localApiGroup.GET("/static/:zpkUrl/:identifie/:version/frontend/*path", middleware.Auth{}.Process, controller2.Static{}.FrontendProxy)
		...
		localApiGroup.POST("/files/mvtopod", middleware.Auth{}.Process, middleware.Auth{}.Process, controller2.File{}.MoveToPod) //pid文件移动
