...
func (p Provider) RegisterHttpRoutes(server *httpserver.Server) {
	server.RegisterRouters(func(engine *gin.Engine) {
		...
		// 救援模式cvm 使用
		engine.GET("/panel-api/v1/metrics/usage/cvm/namespace/:namespace/name/:name/normal", middleware.Auth{}.Process, controller2.Metrics{}.UsageCvm)
		engine.GET("/panel-api/v1/metrics/usage/cvm/namespace/:namespace/name/:name/disk", middleware.Auth{}.Process, controller2.Metrics{}.UsageDiskCvm)
